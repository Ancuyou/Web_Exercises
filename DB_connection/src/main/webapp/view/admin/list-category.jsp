...
<%--        <td><%= index++ %></td>--%>
<%--        <td>--%>
<%--            <img src="<%= request.getContextPath() + "/image?fname=" + cate.getIcon() %>"--%>
<%--                 height="80" width="120" alt="Icon"/>--%>
<%--        </td>--%>
<%--        <td><%= cate.getCatename() %></td>--%>
<%--        <td class="action-links">--%>
<%--            <a href="<%= request.getContextPath() + "/admin/category/edit?id=" + cate.getCateid() %>">Sửa</a> |--%>
<%--            <a href="<%= request.getContextPath() + "/admin/category/delete?id=" + cate.getCateid() %>"--%>
...
<%--    <a href="<%= request.getContextPath() + "/admin/category/add" %>" class="btn">+ Thêm Category</a>--%>
<%--</div>--%>
<%--</body>--%>
<%--</html>--%>
