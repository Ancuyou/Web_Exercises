...
<div class="container">
        ...
        <table id="categoryTable">
            ...
            <tr>
                ...
                <td class="action-links">
                    <a href="<%= request.getContextPath() + "/category?action=edit&" + user.getId() %>">Sửa</a> |
                    <a href="<%= request.getContextPath() + "/category?action=delete&" + user.getId()%>"
    ...
    <div class="add-btn-container">
        <a href="<%= request.getContextPath() + "/category/add" %>" class="btn">+ Thêm Category</a>
    </div>
</div>
