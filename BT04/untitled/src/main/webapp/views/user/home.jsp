...
<%--                <a href="<c:url value='/category?action=add/>" class="btn btn-success">--%>
<%--                    Danh mục của tôi--%>
<%--                </a>--%>
                <c:url var="myCategoryUrl" value="/category">
                    <c:param name="action" value="list" />
                    <c:param name="userId" value="${u.id}" />
                </c:url>

                <a href="${myCategoryUrl}" class="btn btn-success">Danh mục của tôi</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-4 h-100">
